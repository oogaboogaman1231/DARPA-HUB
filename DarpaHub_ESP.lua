...
ESPModule.Names = {
    ...
    Color = Color3.fromRGB(255, 255, 255),
    Size = 16,
    Font = Drawing and Drawing.Fonts and Drawing.Fonts.UI or 0,
    Outline = true,
...
function ESP:UpdateTracer()
    ...
    pcall(function()
        ...
        local targetPos, onScreen = WorldToScreen(root.Position)
        ...
        elseif ESPModule.Tracers.From == "Mouse" then
            fromPos = game:GetService("UserInputService"):GetMouseLocation()
        end
